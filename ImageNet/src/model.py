...
class ImageClassifier(nn.Module):
    def __init__(self, num_classes=1000):
        ...
        # Residual blocks
        self.block1 = ConvBlock(in_channels=64, out_channels=64, num_layers=6)
        self.block2 = ConvBlock(in_channels=64, out_channels=128, num_layers=8)
        self.block3 = ConvBlock(in_channels=128, out_channels=256, num_layers=12)
        self.block4 = ConvBlock(in_channels=256, out_channels=512, num_layers=6)
