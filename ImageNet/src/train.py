...
from data_augment import ImageNetDataAugmentation
...
if __name__ == '__main__':
    ...
    # Load datasets using ImageNetDataAugmentation
    train_dataset = ImageNetKaggle("../data", "train", data_augmentation.get_train_transforms())
    test_dataset = ImageNetKaggle("../data", "val", data_augmentation.get_test_transforms())
